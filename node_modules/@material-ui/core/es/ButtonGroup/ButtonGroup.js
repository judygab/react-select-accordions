...
const ButtonGroup = React.forwardRef(function ButtonGroup(props, ref) {
  ...
  const buttonClassName = clsx(classes.grouped, classes[`grouped${capitalize(variant)}`], classes[`grouped${capitalize(variant)}${color !== 'default' ? capitalize(color) : ''}`], disabled && classes.disabled);
