    ...
    return (
      <div className="filter-wrapper">
           <ExpansionPanel className="expansion-panel-wrapper">
            <ExpansionPanelSummary className="expansion-panel-summary" expandIcon={<ExpandMore color="primary" />}>
                ...
                <FormControl component="fieldset" className="field-set">
                  <FormGroup>
                      { this.props.options.filter((option) => {
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox disableRipple={true} color="primary" className="checkbox-wrapper" onChange={(e) => this._onSelect(this.state.category, e.target.value)} value={opt} key={id}  checked={(this.state.values.indexOf(opt) > -1) ? true : false}/>
                          }
                          label={opt}
